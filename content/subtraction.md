...
Subtraction analysis to compare the results of two ALE meta-analyses was originally implemented by {cite:p}`Laird2005-qh` and later extended by {cite:p}`Eickhoff2012-hk`.
